...
$catalogue = new MessageCatalogue('it', array (
  ...
  array (
    ...
    'Account' => 'account',
    'Profile' => 'Profilo',
    'Upload a Profile Image (100px x 100px)<br> in PNG or JPG Format' => 'Carica unimmagine del profilo (100px x 100px) <br> in formato PNG o JPG',
    ...
    'Signature' => 'Firma',
    'User signature will be append at the bottom of ticket reply box' => 'La firma dellutente verrà aggiunta nella parte inferiore della casella di risposta del ticket',
    ...
    'User signature will be append in the bottom of ticket reply box' => 'La firma dellutente verrà aggiunta nella parte inferiore della casella di risposta del ticket',
    'Account Status' => 'Stato dell account',
    'Account is Active' => 'Laccount è attivo',
    'Assigning group(s) to user to view tickets regardless assignment.' => 'Assegnazione di gruppo / i allutente per visualizzare i biglietti indipendentemente dallassegnazione.',
    'Default' => 'Predefinito',
    'Select All' => 'Seleziona tutto',
    'Remove All' => 'Rimuovi tutto',
    'Assigning team(s) to user to view tickets regardless assignment.' => 'Assegnazione di una o più squadre allutente per visualizzare i biglietti indipendentemente dallassegnazione.',
    ...
    'Action' => 'Azione',
    'Account Owner' => 'Titolare dellaccount',
    'Active' => 'Attivo',
    'Edit' => 'modificare',
    'Delete' => 'Elimina',
    ...
    'Update Mailbox' => 'Aggiorna cassetta postale',
    'Add Mailbox' => 'Aggiungi cassetta postale',
    'Mailbox ID - Leave blank to automatically create id' => 'ID cassetta postale - Lascia vuoto per creare automaticamente lid',
    ...
    'Customer Reply To The Agent' => 'Risposta del cliente allagente',
    ...
    'Agent Reply To The Customers ticket' => 'Biglietto dellagente per la risposta al cliente',
    ...
    'email template will be used for work related with selected option' => 'modello di email verrà utilizzato per lavori relativi allopzione selezionata',
    ...
    'Agent Replied on Ticket' => 'Risposta dellagente sul biglietto',
    ...
    'Mail to last collaborator' => 'Posta allultimo collaboratore',
    ...
    'Content' => 'Soddisfare',
    'Slug' => 'lumaca',
    'Slug is the url identity of this article.' => 'La lumaca è lidentità dellURL di questo articolo.',
    ...
    'Redirect to list' => 'Reindirizza allelenco',
    ...
    'Label with same name already exist.' => 'Letichetta con lo stesso nome esiste già.',
    ...
    'Can edit task' => 'Può modificare lattività',
    'Can create task' => 'Può creare attività',
    'Can delete task' => 'Può eliminare lattività',
    'Can add member to task' => 'Può aggiungere un membro allattività',
    'Can remove member from task' => 'Può rimuovere un membro dallattività',
    ...
    'User can view tickets based on selected scope.' => 'Lutente può visualizzare i biglietti in base allambito selezionato.',
    'If individual access then user can View assigned Ticket(s) only, If Team access then user can view all Ticket(s) in team(s) he belongs to and so on' => 'Se laccesso individuale quindi lutente può visualizzare solo i ticket assegnati, se laccesso alla squadra quindi lutente può visualizzare tutti i ticket della squadra a cui appartiene e così via',
    ...
    'Success ! Article Related is already added.' => 'Successo! Larticolo è già stato aggiunto. ',
    ...
    'Success ! Article status updated successfully.' => 'Successo! Stato dellarticolo aggiornato correttamente. ',
    'Success ! Article star updated successfully.' => 'Successo! Stella dellarticolo aggiornata correttamente. ',
    ...
    'Error ! Profile image is not valid, please upload a valid format' => 'Errore! Limmagine del profilo non è valida, carica un formato valido',
    ...
    'Success! Order has been updated successfully.' => 'Successo! Lordine è stato aggiornato correttamente. ',
    ...
    'Warning ! You are allowed to remove account owners account.' => 'Avviso! Puoi rimuovere laccount del proprietario dellaccount.',
    ...
    'Success ! Ticket to label removed successfully.' => 'Successo! Il biglietto per letichetta è stato rimosso con successo.',
    ...
    'Error ! Label name can not be blank.' => 'Errore! Il nome delletichetta non può essere vuoto.',
    ...
    'Mailbox configuration removed successfully.' => 'Configurazione della cassetta postale rimossa correttamente.',
    'visit our website' => 'visita il nostro sito web',
    'Cookie Usage Policy' => 'Informativa sulluso dei cookie',
    'cookie' => 'biscotto',
    'cookies' => 'biscotti',
    'HELP' => 'AIUTO',
    'Home' => 'Casa',
    ...
    'Looking for something specific? Choose a relevant category from below to explore possible solutions' => 'Alla ricerca di qualcosa di specifico? Scegli una categoria pertinente dal basso per esplorare le possibili soluzioni',
    'No Categories Found!' => 'Nessuna categoria trovata',
    'Powered by' => 'Offerto da',
    'Forgot Password' => 'Ha dimenticato la password',
    'Enter your email address and we will send you an email with instructions to update your login credentials.' => 'Inserisci il tuo indirizzo email e ti invieremo unemail con le istruzioni per aggiornare le tue credenziali di accesso.',
    ...
    'Upload an Image (200px x 48px) in</br> PNG or JPG Format' => 'Carica unimmagine (200px x 48px) in </br> formato PNG o JPG',
    'It will be shown as Logo on Knowledgebase and Helpdesk' => 'Verrà mostrato come logo nella knowledge base e nellhelpdesk',
    ...
    'Header Background Color' => 'Colore di sfondo dellintestazione',
    ...
    'Broadcast message content to show on helpdesk' => 'Trasmetti il ​​contenuto del messaggio da mostrare sullhelpdesk',
    'From' => 'A partire dal',
