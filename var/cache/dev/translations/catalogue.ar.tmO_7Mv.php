...
$catalogue = new MessageCatalogue('ar', array (
  ...
  array (
    ...
    'Sign Out' => 'خروج',
    'Apps' => 'تطبيقات',
    'Integrate apps as per your needs to get things done faster than ever' => 'دمج التطبيقات وفقًا لاحتياجاتك لإنجاز الأمور بشكل ',
    'Explore Apps' => 'استكشاف التطبيقات',
    'Form Builder' => 'منشئ النموذج',
    'Knowledgebase' => 'قاعدة المعرفة',
    'Knowledgebase is a source of rigid and complex information which helps Customers to help themselves' => 'قاعدة المعرفة هي ',
    'Articles' => 'مقالات',
    'Categories' => 'التصنيفات',
    'Folders' => 'المجلدات',
    'FOLDERS' => 'المجلدات',
    'Productivity' => 'إنتاجية',
    'Automate your processes by creating set of rules and presets to respond faster to the tickets' => 'أتمتة عملياتك عن طريق ',
    ...
    'Workflows' => 'سير العمل',
    'Settings' => 'الإعدادات',
    'Manage your Brand Identity, Company Information and other details at a glance' => 'إدارة هوية علامتك التجارية ومعلومات ',
    ...
    'Import ecommerce order details to your support tickets from different available platforms' => 'استيراد تفاصيل طلب التجارة ',
    'Search' => 'بحث',
    'Sort By' => 'صنف حسب',
    'Sort By:' => ' صنف حسب:',
    'Status' => 'الحالة',
    ...
    'You did not add any folder to your Knowledgebase yet, Create your first Folder and start adding Categories/Articles to make your customers help themselves.' => 'لم تقم بإضافة أي مجلد إلى قاعدة معارفك حتى الآن ، قم بإنشاء المجلد الأول وابدأ في ',
    ...
    'Upload a Profile Image (100px x 100px)<br> in PNG or JPG Format' => 'تحميل صورة ملف شخصي (100 بكسل × 100 بكسل) <br> بتنسيق ',
    ...
    'Password' => 'كلمه السر',
    'Password will remain same if you are not entering something in this field' => 'ستبقى كلمة المرور كما هي إذا لم تقم بإدخال ',
    ...
    'Assigning group(s) to user to view tickets regardless assignment.' => 'تعيين مجموعة (مجموعات) للمستخدم لعرض التذاكر بغض ',
    'Default' => 'الإفتراضي',
    'Select All' => 'اختر الكل',
    'Remove All' => 'حذف الكل',
    'Assigning team(s) to user to view tickets regardless assignment.' => 'تعيين فريق (فرق) للمستخدم لعرض التذاكر بغض النظر عن ',
    ...
    'Easily integrate different ecommerce platforms with your helpdesk which can then be later used to swiftly integrate ecommerce order details with your support tickets.' => 'يمكنك دمج منصات التجارة الإلكترونية المختلفة بسهولة مع مكتب المساعدة ',
    ...
    'Easily embed custom form to help generate helpdesk tickets.' => 'تضمين نموذج مخصص بسهولة للمساعدة في إنشاء تذاكر مكتب ',
    ...
    'These fields will be visible in form and cant be edited' => 'ستكون هذه الحقول مرئية في النموذج ولا يمكن تحريرها',
    'Reply' => 'الرد',
    ...
    'Comma (,) separated values (Eg. support@example.com, @example.com, 68.98.31.226)' => 'القيم المفصولة بفواصل (،) (مثل ',
    ...
    'Add Mailbox' => 'إضافة صندوق البريد',
    ...
    'Configure your imap settings which will be used to fetch emails from your mailbox.' => 'قم بتهيئة إعدادات imap التي سيتم ',
    'Transport' => 'المواصلات',
    'IMAP' => 'IMAP',
    'Gmail' => 'جوجل',
    'Yahoo' => 'ياهو',
    ...
    'Select a valid Swift Mailer configuration which will be used to send emails through your mailbox.' => 'حدد تهيئة Swift ',
    ...
    'Ticket will be created with current ticket\'s customer' => 'سيتم إنشاء تذكرة مع عميل التذكرة الحالية',
    ...
    'Agent Reply To The Customer ticket' => 'رد الوكيل على تذكرة العميل',
    ...
    'email template will be used for work related with selected option' => 'سيتم استخدام قالب البريد الإلكتروني للعمل المرتبط ',
    ...
    'Events' => 'أحداث',
    'An event automatically triggers to check conditions and perform a respective pre-defined set of actions' => 'يتم تشغيل الحدث ',
    'Select an Event' => 'اختر حدثًا',
    'Add More' => 'أضف المزيد',
    'Conditions' => 'الظروف',
    'Conditions are set of rules which checks for specific scenarios and are triggered on specific occasions' => 'الشروط هي ',
    'Subject or Description' => 'الموضوع أو الوصف',
    'Actions' => 'أجراءات',
    'An action not only reduces the workload but also makes it quite easier for ticket automation' => 'لا يقلل الإجراء من عبء ',
    ...
    'Share saved reply with user(s) in these group(s)' => 'مشاركة الرد المحفوظ مع المستخدم (المستخدمين) في هذه المجموعة ',
    ...
    'Share prepared response with user(s) in these group(s)' => 'مشاركة الاستجابة المعدة مع المستخدم (المستخدمين) في هذه المجموعة ',
    'Share prepared response with user(s) in these teams(s)' => 'مشاركة الاستجابة المعدة مع المستخدم (المستخدمين) في هذه الفرق ',
    ...
    'A small text about the folder helps user to navigate more easily' => 'نص صغير حول المجلد يساعد المستخدم على التنقل بسهولة ',
    'Publish' => 'نشر',
    'Choose appropriate status' => 'اختيار الحالة المناسبة',
    'Folder Image' => 'صورة المجلد',
    'An image is worth a thousands words and makes folder more accessible' => 'الصورة تستحق آلاف الكلمات وتجعل الوصول إلى المجلد ',
    'Add Category' => 'إضافة فئة',
    'Category Name is shown upfront at Knowledge Base' => 'يظهر اسم الفئة مقدمًا في Knowledge Base',
    'A small text about the category helps user to navigate more easily' => 'نص صغير حول الفئة يساعد المستخدم على التنقل بسهولة ',
    'Using Category Order, you can decide which category should display first' => 'باستخدام ترتيب الفئة ، يمكنك تحديد الفئة التي ',
    'Sorting' => 'فرز',
    ...
    'Title' => 'عنوان',
    'View' => 'رأي',
    'Make as Starred' => 'كما نجمة مميزة',
    'Yes' => 'نعم',
    'No' => 'لا',
    'Stared' => 'حدق',
    'Revisions' => 'التنقيحات',
    ...
    'Can manage Groups Saved Reply' => 'يمكن إدارة الرد المحفوظ للمجموعة',
    ...
    'Enter your credentials below to gain access to your helpdesk account.' => 'أدخل بيانات الاعتماد الخاصة بك أدناه للوصول إلى ',
    ...
    'To' => 'إلى',
    'Ticket' => 'تذكرة',
    'Your browser does not support JavaScript or You disabled JavaScript, Please enable those !' => 'متصفحك لا يدعم JavaScript أو ',
    ...
    'Add Team' => 'إضافة فريق',
    'delete' => 'حذف',
    'You did not have any folder for current filter(s).' => 'لم يكن لديك أي مجلد للمرشحات الحالية.',
    ...
    'If individual access then user can View assigned Ticket(s) only, If Team access then user can view all Ticket(s) in team(s) he belongs to and so on' => 'إذا كان الوصول الفردي ، فيمكن للمستخدم عرض التذاكر (التذاكر) المخصصة فقط ، وإذا كان الوصول إلى ',
    ...
    'Apps Dashboard' => 'تطبيقات لوحة القيادة',
    'Nothing Interesting here' => 'لا شيء مثير للاهتمام هنا',
    ...
    'Password dont match.' => 'كلمة المرور غير متطابقة.',
    'Error ! Profile image is not valid, please upload a valid format' => 'خطأ! صورة الملف الشخصي غير صالحة ، يرجى تحميل تنسيق ',
    ...
    'Warning ! Cannot create ticket, given email is blocked by admin.' => 'تحذير ! لا يمكن إنشاء تذكرة ، حيث يتم حظر البريد ',
    ...
    'You need to login to your account before can perform this action.' => 'يجب عليك تسجيل الدخول إلى حسابك قبل أن تتمكن من تنفيذ ',
    ...
    'You dont have premission to edit this Prepared response' => 'ليس لديك قرار مسبق بتحرير هذا الرد المعد',
    ...
    'Warning ! You are allowed to remove account owners account.' => 'تحذير! يُسمح لك بإزالة حساب مالك الحساب.',
    ...
    'Warning! You can not remove predefined email template which is being used in workflow(s).' => 'تحذير! لا يمكنك إزالة قالب ',
    ...
    'Please check your mail for password update' => 'يرجى التحقق من البريد الخاص بك للحصول على تحديث كلمة المرور',
    'This email address is not registered with us' => ' عنوان البريد الإلكتروني هذا غير مسجل لدينا',
    'You have already update password using this link if you wish to change password again click on forget password link here from login page' => 'لقد قمت بالفعل بتحديث كلمة المرور باستخدام هذا الرابط إذا كنت ترغب في تغيير كلمة المرور مرة أخرى ، انقر على رابط نسيت كلمة المرور هنا من صفحة تسجيل الدخول',
    ...
    'Please try again, The passwords do not match' => 'يرجى المحاولة مرة أخرى ، كلمات المرور غير متطابقة',
    ...
    'Success! Saved Reply has been deleted successfully.' => 'نجاح! تم حفظ الرد المحفوظ بنجاح.',
    'SwiftMailer configuration created successfully.' => 'تم تكوين تكوين SwiftMailer بنجاح.',
    'SwiftMailer configuration updated successfully.' => 'تم تحديث تكوين SwiftMailer بنجاح.',
    'Swiftmailer configuration removed successfully.' => 'تمت إزالة تهيئة Swiftmailer بنجاح.',
    'No swiftmailer configurations found for mailer id:' => 'لم يتم العثور على تكوينات لـ swiftmailer لمعرف mailer',
    ...
    'Reply added to the ticket and forwarded successfully.' => 'تمت إضافة الرد إلى التذكرة وإعادة توجيهها بنجاح.',
    'Success ! Thread updated successfully.' => 'نجاح ! تم تحديث الخيط بنجاح.',
    'Success ! Thread removed successfully.' => 'نجاح ! تمت إزالة الموضوع بنجاح.',
    'Success ! Thread pinned successfully.' => 'نجاح ! الموضوع مثبت بنجاح.',
    'Success ! unpinned removed successfully.' => 'نجاح ! إزالة غير مأهول بنجاح.',
    'Could not create ticket, invalid details.' => 'لا يمكن إنشاء تذكرة ، تفاصيل غير صالحة.',
    ...
    'Success ! Ticket moved to trash successfully.' => ' نجاح ! تم نقل التذكرة إلى المهملات بنجاح.',
    'Success ! Ticket has been updated successfully.' => 'نجاح ! تم تحديث التذكرة بنجاح.',
    'Unable to retrieve priority details' => 'غير قادر على استرداد تفاصيل الأولوية',
    ...
    'Ticket assigned to support group ' => 'تم تخصيص تذكرة لمجموعة الدعم',
    'Success ! Ticket to label removed successfully.' => 'نجاح ! تمت إزالة البطاقة إلى التصنيف بنجاح.',
    'Success ! Tag added successfully.' => 'نجاح ! تم إضافة العلامة بنجاح.',
    'Success ! Tag updated successfully.' => 'نجاح ! تم تحديث العلامة بنجاح. ',
    'Error ! Customer can not be added as collaborator.' => ' خطأ! لا يمكن إضافة العميل كمتعاون.',
    'Success ! Tag unassigned successfully.' => ' نجاح ! تم إلغاء تعيين العلامة بنجاح.',
    'Error ! Invalid tag.' => 'خطأ! علامة غير صالحة. ',
    'Mailbox configuration removed successfully.' => ' تمت إزالة تكوين صندوق البريد بنجاح.',
    'visit our website' => 'زيارة موقعنا على الانترنت',
    ...
    'Contact Us' => 'اتصل بنا',
    'If you have ever contacted our support previously, your account would have already been created.' => 'إذا سبق لك أن اتصلت ',
    'support' => 'الدعم',
    'HelpDesk' => 'مكتب المساعدة',
    'Enter search keyword' => 'أدخل كلمة البحث',
    'Browse via Folders' => 'تصفح عبر المجلدات',
    'Looking for something that is queried generally? Choose a relevant folder from below to explore possible solutions' => 'هل ',
    'Unable to find an answer?' => 'غير قادر على العثور على إجابة؟',
    'Looking for anything specific article which resides in general queries? Just browse the various relevant folders and categories and then you will find the desired article.' => 'تبحث عن أي شيء محدد المادة التي تكمن في الاستفسارات العامة؟ فقط ',
    'Popular Articles' => 'المواد شعبية',
    'Here are some of the most popular articles, which helped number of users to get their queries and questions resolved.' => 'فيما يلي بعض المقالات الأكثر شيوعًا ، والتي ساعدت عددًا من المستخدمين على حل استفساراتهم وأسئلتهم.',
    'Browse via Categories' => 'تصفح عبر الفئات',
    'Looking for something specific? Choose a relevant category from below to explore possible solutions' => 'تبحث عن شيء معين؟ ',
    'No Categories Found!' => 'لم يتم العثور على فئات',
    'Powered by' => 'مشغل بواسطة',
    'Forgot Password' => 'هل نسيت كلمة المرور',
    'Enter your email address and we will send you an email with instructions to update your login credentials.' => 'أدخل عنوان ',
    ...
    'To know more about how our privacy policy works, please %websiteLink%.' => 'لمعرفة المزيد حول كيفية عمل سياسة الخصوصية ',
    ...
    'Enable front end website and knowledgebase for customer(s)' => 'دمج التطبيقات وفقًا لاحتياجاتك لإنجاز الأمور بشكل أسرع من أي ',
    ...
    'Provide a valid url(with protocol)' => 'استيراد تفاصيل طلب التجارة الإلكترونية إلى تذاكر الدعم الخاصة بك من منصات مختلفة ',
  ),
));
